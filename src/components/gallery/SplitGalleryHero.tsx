...
export default function SplitGalleryHero({ items }: { items: GalleryItem[] }) {
  ...
  return (
    <div className="w-full flex flex-col lg:flex-row items-center justify-between px-4 sm:px-8 lg:px-16 pt-12 pb-12 lg:pt-2 lg:pb-16 bg-[#0f172a] gap-8 lg:gap-12">
